 ...
 */
export const isDeno: boolean = globalThis.Deno?.version?.deno !== undefined;
 ...
 */
const platform: string | undefined = globalThis.navigator?.userAgentData?.platform;

/**
 * Indicates whether the code is running on macOS.
 * Detects both Intel and Apple Silicon Macs.
