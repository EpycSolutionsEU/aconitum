/**
 * East Asian Width lookup functions for Unicode characters.
 * 
 * This module provides functions to determine the East Asian Width property
 * of Unicode characters, which is useful for terminal display and text layout.
 * 
 * The East Asian Width property categorizes characters into different width classes:
 * - Ambiguous: Characters that can be narrow or wide depending on context
 * - Fullwidth: Characters that are always displayed as wide
 * - Halfwidth: Characters that are always displayed as narrow
 * - Narrow: Characters that are always displayed as narrow
 * - Wide: Characters that are always displayed as wide
 * - Neutral: Characters that do not have a specific width property
 * 
 * @see https://www.unicode.org/reports/tr11/ for the Unicode East Asian Width standard
 */

/**
 * Checks if a Unicode character has the 'Ambiguous' East Asian Width property.
 * 
...
/**
 * Checks if a Unicode character has the 'Fullwidth' East Asian Width property.
 * 
...
/**
 * Checks if a Unicode character has the 'Wide' East Asian Width property.
 * 
...
/**
 * Returns the East Asian Width category of a Unicode character.
 * 
 * This function determines which of the six East Asian Width categories
 * a character belongs to by checking various code point ranges and
 * using the helper functions for specific categories.
 * 
 * The categories are:
 * - 'ambiguous': Characters that can be narrow or wide depending on context
 * - 'fullwidth': Characters that are always displayed as wide
